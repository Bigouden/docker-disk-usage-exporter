...
ENV DOCKER_DISK_USAGE_EXPORTER_PORT=8123
ENV DOCKER_DISK_USAGE_EXPORTER_LOGLEVEL='INFO'
ENV DOCKER_DISK_USAGE_EXPORTER_NAME='docker-disk-usage-exporter'
ENV SCRIPT="docker_disk_usage_exporter.py"
ENV USERNAME="exporter"
ENV UID="1000"
ENV GID="1000"
ENV VIRTUAL_ENV="/docker-disk-usage-exporter"
...
USER ${USERNAME}
WORKDIR ${VIRTUAL_ENV}
EXPOSE ${DOCKER_DISK_USAGE_EXPORTER_PORT}
HEALTHCHECK CMD nc -vz localhost "${DOCKER_DISK_USAGE_EXPORTER_PORT}" || exit 1 # nosemgrep
